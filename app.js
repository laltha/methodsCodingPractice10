...
const convertStatesToResponseObject = dbObject => {
  return {
...
const convertDistrictsToResponseObject = dbObject => {
  return {
...
app.get('/states/', authenticateToken, async (request, response) => {
  ...
  response.send(
    statesArray.map(eachState => convertStatesToResponseObject(eachState)),
  )
})
...
app.get('/states/:stateId/', authenticateToken, async (request, response) => {
  ...
  response.send(convertStatesToResponseObject(state))
})
...
app.get(
  ...
  async (request, response) => {
    ...
    response.send(convertDistrictsToResponseObject(district))
  },
)
